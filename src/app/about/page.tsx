      ...
      <main className="space-y-28 pb-20 font-sans">
        ...
        <section className="relative w-full h-[50vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full text-center space-y-4">
            <span className="text-xs font-mono tracking-widest text-primary uppercase bg-primary/10 border border-primary/20 rounded-full px-3 py-1">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 text-left">
          <div className="lg:col-span-7 space-y-6">
            <h2 className="heading-premium text-3xl text-white font-semibold">The Story of AURA</h2>
          ...
          <div className="lg:col-span-5 p-8 glass-panel rounded-2xl border border-white/10 flex flex-col justify-between space-y-8">
            <div className="space-y-3">
              <span className="text-xs font-mono uppercase text-primary tracking-widest block">Design Principles</span>
              <h3 className="heading-premium text-xl text-white">Our Sustainability Vision</h3>
            ...
            <div className="grid grid-cols-2 gap-4 text-xs font-mono text-white border-t border-white/5 pt-4">
        ...
        <section className="bg-white/[0.01] border-y border-white/5 py-20 text-left">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            
            <div className="lg:col-span-5 relative">
              <div className="relative w-full max-w-sm aspect-[4/5] rounded-xl overflow-hidden border border-white/10 shadow-2xl mx-auto">
            ...
            <div className="lg:col-span-7 space-y-6">
              <h2 className="heading-premium text-3xl text-white font-semibold">Manufacturing Sophistication</h2>
              <p className="text-sm md:text-base text-secondary-foreground leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 text-xs">
                <div className="space-y-1">
                  <h4 className="font-semibold text-white">Hydrophilic Coatings</h4>
                ...
                <div className="space-y-1">
                  <h4 className="font-semibold text-white">High Breaking Load</h4>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="space-y-4 text-center">
            ...
            <h2 className="heading-premium text-3xl text-white">Our Executive Leadership</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {leadership.map((member, idx) => (
              <div
                key={idx}
                className="flex flex-col p-6 rounded-xl border border-white/10 bg-card hover:border-primary/20 transition-all duration-300 text-left space-y-4 group"
              >
                <div className="relative aspect-square w-24 rounded-xl overflow-hidden border border-white/10 mx-auto sm:mx-0">
                  <img src={member.avatar} alt={member.name} className="w-full h-full object-cover" />
                </div>
                <div className="space-y-1">
                  <h4 className="text-base font-display text-white font-bold group-hover:text-primary transition-colors">{member.name}</h4>
